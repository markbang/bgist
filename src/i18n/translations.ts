...
const translations: Record<Language, Record<string, string>> = {
  ...
  zh: {
    ...
    'settings.themePresetDefault': '默认',
    'settings.themePresetOcean': '海蓝',
    'settings.themePresetForest': '森林',
    'settings.themePresetSunset': '日落',
    'settings.themePresetCurrent': '当前',
    'settings.themePresetDefaultDescription': '中性的 GitHub 风格配色。',
    ...
    'settings.updatesLastChecked': '上次检查：{date}',
